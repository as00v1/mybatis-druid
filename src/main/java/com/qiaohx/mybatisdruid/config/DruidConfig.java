...
public class DruidConfig {
    ...
    public ServletRegistrationBean druidServlet() { // 主要实现WEB监控的配置处理
        ...
        servletRegistrationBean.addInitParameter("allow","127.0.0.1,192.168.1.159"); // 可以访问druid的白名单
        ...
        servletRegistrationBean.addInitParameter("loginPassword", "0183117307"); // 密码
